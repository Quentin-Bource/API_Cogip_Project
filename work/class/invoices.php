...
class invoices extends Dbh
{
    ...
    {
        $sql = "SELECT invoices.id , ref, invoices.update_dat AS Date_due , invoices.create_dat, companies.name AS Name_company, companies.tva, companies.country, companies.type_id , companies.id AS IDCOMPANY FROM invoices
        INNER JOIN companies
